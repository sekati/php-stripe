...
class Stripe {
     ...
     * @param  array         Associative array of extra data you want to store with the transacation
     */
    public function charge_customer( $amount, $customer_id, $desc, $meta='' ) {
        $params = array(
            'amount' => $amount,
     ...
     * @param  string        A free form reference for the charge
     * @param  string        A true or false string: true=auth and capture; false=auth only
     * @param  array         Associative array of extra data you want to store with the transacation
     *
     */
    public function charge_card( $amount, $card, $desc, $capture='true', $meta='' ) {
        $params = array(
            'amount'        =>  $amount,
            'currency'      =>  $this->_conf['stripe_currency'],
            'card'          =>  $card,
     ...
     */
    public function customer_create( $card, $email, $desc = NULL, $plan = NULL, $coupon = NULL, $meta = NULL ) {
        $params = array(
            'card' => $card,
            'email' => $email
        );
